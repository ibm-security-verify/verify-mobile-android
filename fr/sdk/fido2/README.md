# IBM Security Verify FIDO2™ SDK pour Android
...
1. Installez les SDK dans votre dépôt Maven local (en général, c'est `~/.m2` ):
...
<!-- v2.3.7 : caits-prod-app-gp_webui_20241231T140353-12_en_fr -->