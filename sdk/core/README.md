...
The `Core` SDK provides common functionality across the other SDKs in the IBM Security Verify SDK offering. It will evolve over time and currently offers a unified logging module, Keystore services for creating and persisting private keys along with export functionality of the public key. The error module is an abstract class for other SDKs to implement customised error details.
